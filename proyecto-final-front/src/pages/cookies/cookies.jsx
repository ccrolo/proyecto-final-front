    ...
    return (
        <React.Fragment>
            ...
            <Card className="m-5 border-0">
                ...
                <ul>
                    <li><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Cookies Policy) refers to Bitacora.</li>
                    <li><strong>Cookies</strong> means small files that are placed on Your computer, mobile device or any other device by a website, containing details of your browsing history on that website among its many uses.</li>
                    <li><strong>Website</strong> refers to Bitacora, accessible from <a href="http://localhost:3000/" rel="external nofollow noopener" target="_blank">http://localhost:3000/</a></li>
                ...
                <ul>
                    <li>By email: bitacora.new@gmail.com</li>
                </ul>
            </Card>
            <Footer />
        </React.Fragment>
